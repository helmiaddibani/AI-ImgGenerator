...
const generateImage = async () => {
  if (form.prompt) {
    try {
      ...
      const response = await fetch('https://ai-imggenerator-backend-production.up.railway.app/api/v1/dalle', {
        method: 'POST',
        headers: {
...
const handleSubmit = async(e) => {
  e.preventDefault() //prevent the browser to reload the application
  if(form.prompt && form.photo){
    ...
    alert('Enter promt and generate the image')
  }
}
...
const handleSurpriseMe = () => {
  ...
  return (
    ...
    <div>
       ...
       <p className='mt-2 text-[#666e75] text-[14px] max-w[500px]'>Generate through the collection generated by Dall-E</p>        
    </div>
